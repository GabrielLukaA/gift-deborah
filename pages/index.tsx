...
<Header/>
      <div className="flex w-[390px] p-8 flex-col items-center gap-4">
        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <Link
            href="/mail"
            className="flexw-[324px] p-4 flex-col items-start gap-4 rounded-2xl bg-[#fcfcfc] dark:bg-[#111]  border-purple dark:active:bg-[#901abb] active:bg-[#901abb] active:text-[#FCFCFC]"
          >
          ...
          <Link
            href="/amo-te"
            className="flexw-[324px] p-4 flex-col items-start gap-4 rounded-2xl bg-[#fcfcfc] dark:bg-[#111]  border-purple active:bg-[#901abb] active:text-[#FCFCFC]"
          >
            <h3 className="paragraph-16 dark:text-[#FCFCFC]">
              Gerador de momentos!
            </h3>
